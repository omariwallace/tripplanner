...
// Seeding the database allows developers to work with their sites and have a boilerplace database in info to work with
// File pre loads the mondo db with data
// Hotel.create both creates a new entry and saves it to the database at the same time
